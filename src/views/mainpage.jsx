    ...
    <div className="main">
          ...
          <div className="card_wrap flex justify-around">
            ...
            <div className="rounded-[15px] bg-[linear-gradient(180deg, rgba(233, 222, 251, 0.71) 0%, #C5A3FB 100%);] w-[350px] h-[570px] relative icon_card">
              ...
              <img
                src={icon3}
                alt="icon"
                className="absolute bottom-[55px] left-[0] right-0 mx-auto"
              />
            </div>
          </div>
        </div>
      ...
      <section className="h-[1080px] relative">
        <div className="flex flex-col justify-center gap-[72px] h-full">
          <div className="service max-w-[1170px] rounded-[10px] h-[301px] mx-auto px-[63px] py-[60px] w-full relative z-10">
      ...
      <section className="h-[1080px] ">
        <div className="wrap flex flex-col justify-center gap-[88px] relative h-full ">
          <div className="cont relative w-full">
            ...
            />
            <h2 className="text-[#393939] font-title leading-normal text-[40px] text-center">
              현재와 과거를
            ...
            <h3 className="text-[#bbbbbb] font-title leading-normal text-[40px] text-center">
      ...
      <section className="h-screen">
        <div className="cont h-full flex flex-col justify-center">
          <h2 className="text-[#393939] font-title text-[40px] text-center mb-[68px]">
            빠르게{" "}
