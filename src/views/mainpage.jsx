    ...
    <div className="main">
      ...
      <section className="h-screen relative overflow-hidden">
        <div className="cont mx-auto flex flex-col justify-center gap-[96px] h-full">
          ...
          <img
            src={pic2}
            alt="robot"
            className="w-[977px] aspect-square h-auto absolute top-0 bottom-0 right-[-248px] fade-left"
          />
      ...
      <section className="h-screen">
        <div className="flex flex-col gap-[102px] cont justify-center h-full relative">
          <img
            src={pic3}
            alt="bg"
            className="absolute w-[760px] aspect-square h-auto z-[-1] left-0 right-0 mx-auto fade-bottom bouncer"
          />
          <p className="font-normal text-6xl text-center text-[black] font-title fade-in-left">
            퍼블리싱 전문 업체 - 디자인을 현실로
          </p>
      ...
      <section className="h-[1080px] relative">
        <div className="flex flex-col justify-center gap-[72px] h-full">
          <div className="service max-w-[1170px] rounded-[10px] h-[301px] mx-auto px-[63px] py-[60px] w-full relative z-10 fade-left">
